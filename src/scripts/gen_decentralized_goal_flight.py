def generate_launch_file(num_drones, init_x, init_y_spacing, output_file='decentralized_goal_flight.launch'):
    with open(output_file, 'w') as file:
        ...
        for i in range(num_drones):
            ...
            file.write('        <arg name="sim_distributed_communication" value="$(arg sim_distributed_communication)"/>\n')
...
if __name__ == "__main__":
    ...
    generate_launch_file(drone_num, init_x, init_y_spacing, os.path.join(launch_dir, 'decentralized_goal_flight.launch'))
