...
def generate_launch_file(start_num, end_num, total_num, radius, obs_density, goal_center, goal_radius, output_file):
...
if __name__ == "__main__":
    ...
    generate_launch_file(0, drone_num - 1, drone_num, radius, 1.0, goal_center, goal_radius, launch_dir + 'swarm.launch')
